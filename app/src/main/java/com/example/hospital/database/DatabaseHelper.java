...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_USER_BLOOD_TYPE = "user_blood";
    private static final String COLUMN_USER_SITUATION = "user_situation";
    ...
    public void addUser(User user) {
        ...
        values.put(COLUMN_USER_SITUATION, user.getSituation());
    ...
    public User getUser(String email) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                user.setSituation(cursor.getString(cursor.getColumnIndex(COLUMN_USER_SITUATION)));
                user.setName(cursor.getString(cursor.getColumnIndex(COLUMN_USER_NAME)));
                user.setBloodType(cursor.getString(cursor.getColumnIndex(COLUMN_USER_BLOOD_TYPE)));
                // Adding user record to list
                return user;
            } while (cursor.moveToNext());
        }
